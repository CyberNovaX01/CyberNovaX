...
export const FF_CHARACTERS: FFCharacter[] = [
  ...
  { id: "kassie", name: "Kassie", emoji: "💉", role: "support", tier: "S", accent: "#22c55e",
    skillName: "Electro Therapy",
    abilityKm: "បង្កើតចំណងព្យាបាលជាមួយមិត្តរួមក្រុម សង្គ្រោះ 3 HP/s ទាំងពីរ។ ប្រើម្តងទៀតដើម្បីព្យាបាល 120 HP ភ្លាមៗ",
    abilityEn: "Forms a healing bond with a teammate, restoring 3 HP/s for both. Use again to instantly heal 120 HP",
    cooldown: "Passive", bestWeapon: "MP40 / M1887",
    tipsKm: "ភ្ជាប់ជាមួយតួអង្គដែលមាន HP ទាប ដើម្បីព្យាបាលពួកគេ", tipsEn: "Bond with low HP teammates to heal them",
  ...
  { id: "adam", name: "Adam", emoji: "🧑", role: "rusher", tier: "B", accent: "#6b7280",
    skillName: "No Skill",
    abilityKm: "តួអង្គចាប់ផ្តើម — គ្មាន Skill ពិសេស",
    abilityEn: "Starter character — no special ability",
    cooldown: "None", bestWeapon: "MP40 / M1887",
    tipsKm: "សមស្របសម្រាប់អ្នកលេងថ្មី", tipsEn: "Best for new players",
    bestForKm: "អ្នកលេងថ្មី", bestForEn: "New players" },

  { id: "eve", name: "Eve", emoji: "👩", role: "rusher", tier: "B", accent: "#6b7280",
    skillName: "No Skill",
    abilityKm: "តួអង្គចាប់ផ្តើម — គ្មាន Skill ពិសេស",
    abilityEn: "Starter character — no special ability",
    cooldown: "None", bestWeapon: "MP40 / M1887",
  ...
  { id: "a_patroa", name: "A-Patroa", emoji: "🎤", role: "support", tier: "A", accent: "#22c55e",
    skillName: "Music Store",
    abilityKm: "Slot Skill ពិសេសអាចដាក់ Skill ណាមួយដែលអ្នកមាន ហើយ Slot ផ្សេងទៀតបើកដោយស្វ័យប្រវត្តិ",
    abilityEn: "Exclusive slot can equip any owned skill, remaining slots unlock automatically",
    cooldown: "Varies", bestWeapon: "MP40 / M1887",
    tipsKm: "បត់បែនបានខ្ពស់ — ប្រើ Skill ណាក៏បាន", tipsEn: "Highly flexible — use any skill",
    bestForKm: "ការលេងបែបបត់បែន", bestForEn: "Flexible playstyles" },

  { id: "dasha", name: "Dasha", emoji: "🏃‍♀️", role: "rusher", tier: "A", accent: "#ef4444",
    skillName: "Dash",
    abilityKm: "បង្កើនល្បឿនរត់ និងបន្ថយការខូចខាតពេលកាន់កាំភ្លើង",
    abilityEn: "Increases running speed and reduces damage taken while holding weapons",
    cooldown: "Passive", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើសម្រាប់ការរត់លឿន និងវាយប្រហារភ្លាមៗ", tipsEn: "Use for fast rush and quick attacks",
    bestForKm: "ការរត់លឿន", bestForEn: "Fast rushing" },

  { id: "homer", name: "Homer", emoji: "🚁", role: "recon", tier: "A", accent: "#f59e0b",
    skillName: "Drone Scan",
    abilityKm: "បញ្ជូន Drone ទៅរកសត្រូវក្នុងរង្វង់ និងវាយប្រហារពួកគេ",
    abilityEn: "Deploys a drone that scans and attacks enemies in radius",
    cooldown: "60s", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើ Drone ដើម្បីរកសត្រូវលាក់ខ្លួន", tipsEn: "Use drone to find hiding enemies",
    bestForKm: "ការរកសត្រូវ", bestForEn: "Enemy detection" },

  { id: "ignis", name: "Ignis", emoji: "🔥", role: "tank", tier: "A", accent: "#ef4444",
    skillName: "Fire Wall",
    abilityKm: "បង្កើតជញ្ជាំងភ្លើងដែលបង្កការខូចខាតដល់សត្រូវ និងផ្តល់ HP ដល់អ្នក",
    abilityEn: "Creates a fire wall that damages enemies and grants HP to self",
    cooldown: "50s", bestWeapon: "M1014 / Groza",
    tipsKm: "ប្រើជញ្ជាំងភ្លើងដើម្បីទប់សត្រូវ", tipsEn: "Use fire wall to block enemies",
    bestForKm: "ការការពារ", bestForEn: "Defense" },

  { id: "iris", name: "Iris", emoji: "🎯", role: "sniper", tier: "B", accent: "#8b5cf6",
    skillName: "Tracking",
    abilityKm: "សម្គាល់សត្រូវដែលអ្នកវាយប្រហារ និងបង្ហាញទីតាំងរបស់ពួកគេ",
    abilityEn: "Marks enemies you hit and reveals their location",
    cooldown: "Passive", bestWeapon: "AWM / Kar98k",
    tipsKm: "ប្រើសម្រាប់ការបាញ់ពីចម្ងាយ និងតាមដានសត្រូវ", tipsEn: "Use for long-range sniping and tracking",
    bestForKm: "ការបាញ់ពីចម្ងាយ", bestForEn: "Long-range sniping" },

  { id: "maro", name: "Maro", emoji: "🦅", role: "sniper", tier: "A", accent: "#8b5cf6",
    skillName: "Falcon Eye",
    abilityKm: "បង្កើនការខូចខាតពេលបាញ់ពីចម្ងាយ និងបង្ហាញសត្រូវ",
    abilityEn: "Increases damage when shooting from distance and reveals enemies",
    cooldown: "Passive", bestWeapon: "AWM / Kar98k",
    tipsKm: "ប្រើសម្រាប់ការបាញ់ពីចម្ងាយ និងការរកសត្រូវ", tipsEn: "Use for long-range sniping and detection",
    bestForKm: "ការបាញ់ពីចម្ងាយ", bestForEn: "Long-range sniping" },

  { id: "morse", name: "Morse", emoji: "📡", role: "recon", tier: "A", accent: "#f59e0b",
    skillName: "Radio Scan",
    abilityKm: "ស្កេនសត្រូវក្នុងរង្វង់ជុំវិញ និងបង្ហាញទីតាំងរបស់ពួកគេ",
    abilityEn: "Scans enemies in radius and reveals their location",
    cooldown: "60s", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើសម្រាប់ការរកសត្រូវលាក់ខ្លួន", tipsEn: "Use to find hiding enemies",
    bestForKm: "ការរកសត្រូវ", bestForEn: "Enemy detection" },

  { id: "sonia", name: "Sonia", emoji: "🛡️", role: "tank", tier: "A", accent: "#3b82f6",
    skillName: "Shield Wall",
    abilityKm: "បង្កើតជញ្ជាំងខែលដែលការពារខ្លួនឯង និងសម្ព័ន្ធមិត្ត",
    abilityEn: "Creates a shield wall that protects self and allies",
    cooldown: "60s", bestWeapon: "M1014 / Groza",
    tipsKm: "ប្រើជញ្ជាំងខែលដើម្បីការពារក្រុម", tipsEn: "Use shield wall to protect the squad",
    bestForKm: "ការការពារក្រុម", bestForEn: "Squad protection" },

  { id: "tatsuya", name: "Tatsuya", emoji: "🥋", role: "tank", tier: "A", accent: "#3b82f6",
    skillName: "Martial Arts",
    abilityKm: "បង្កើនការការពារ និងការខូចខាតពេលប្រយុទ្ធដោយដៃ",
    abilityEn: "Increases defense and damage when fighting hand-to-hand",
    cooldown: "Passive", bestWeapon: "M1014 / Groza",
    tipsKm: "ប្រើសម្រាប់ការប្រយុទ្ធជិត", tipsEn: "Use for close combat",
    bestForKm: "ការប្រយុទ្ធជិត", bestForEn: "Close combat" },

  // ═══════════ NEW ADDED — 13 MORE ═══════════
  { id: "ryden", name: "Ryden", emoji: "🕷️", role: "rusher", tier: "A", accent: "#ef4444",
    skillName: "Spider Trap",
    abilityKm: "បញ្ចេញពីងពាងផ្ទុះដែលអាចបំផ្លាញបាន។ វាដេញតាមសត្រូវដំបូងក្នុងរង្វង់ 5m បន្ថយល្បឿន 80% និងបង្កការខូចខាត 10 HP/s រយៈពេល 5 វិនាទី",
    abilityEn: "Releases an explosive spider that chases the first enemy within 5m, slowing them by 80% and dealing 10 HP/s for 5s",
    cooldown: "60s", bestWeapon: "M1887 / MP40",
    tipsKm: "ប្រើដើម្បីចាប់សត្រូវដែលកំពុងរត់គេច", tipsEn: "Use to catch escaping enemies",
    bestForKm: "ការប្រយុទ្ធជិត", bestForEn: "Close combat" },

  { id: "shirou", name: "Shirou", emoji: "🎯", role: "recon", tier: "A", accent: "#f59e0b",
    skillName: "Damage Delivered",
    abilityKm: "នៅពេលត្រូវវាយ ស្វ័យប្រវត្តិសម្គាល់អ្នកវាយរហូតដល់ 100m និងចែករំលែកព័ត៌មានជាមួយក្រុម",
    abilityEn: "When hit, automatically marks the attacker up to 100m away and shares info with team",
    cooldown: "Passive", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើដើម្បីបង្ហាញទីតាំងសត្រូវឱ្យក្រុម", tipsEn: "Use to reveal enemy positions to your team",
    bestForKm: "ការស្កេនសត្រូវ", bestForEn: "Enemy tracking" },

  { id: "ray", name: "Ray", emoji: "☀️", role: "rusher", tier: "A", accent: "#ef4444",
    skillName: "Bond of Eclipse",
    abilityKm: "បញ្ចេញពន្លឺព្រះអាទិត្យក្នុងរង្វង់ 30m ដើម្បីសម្គាល់សត្រូវដំបូង និងបង្កើតចំណងជាមួយពួកគេរយៈពេល 10 វិនាទី",
    abilityEn: "Releases sunpower in a 30m fan to tag the first enemy hit and creates a link with them for 10s",
    cooldown: "60s", bestWeapon: "M1887 / MP40",
    tipsKm: "ប្រើដើម្បីតាមដានសត្រូវ និងវាយប្រហារពួកគេ", tipsEn: "Use to track enemies and attack them",
    bestForKm: "ការវាយប្រហារលឿន", bestForEn: "Aggressive rushing" },

  { id: "nero", name: "Nero", emoji: "🧸", role: "rusher", tier: "A", accent: "#a855f7",
    skillName: "Dreamsmith",
    abilityKm: "បង្កើតតំបន់ដែលរារាំង Gloo Wall និងបង្កការខូចខាតបន្តបន្ទាប់ដល់សត្រូវនៅខាងក្នុង",
    abilityEn: "Creates a field that blocks Gloo Walls and deals continuous damage to enemies inside",
    cooldown: "50s", bestWeapon: "M1014 / Groza",
    tipsKm: "ប្រើដើម្បីបំផ្លាញ Gloo Wall សត្រូវ និងបង្ខំពួកគេឱ្យចេញពីកន្លែងលាក់ខ្លួន", tipsEn: "Use to destroy enemy Gloo Walls and force them out of hiding",
    bestForKm: "ការប្រយុទ្ធជិត", bestForEn: "Close combat" },

  { id: "suzy", name: "Suzy", emoji: "💰", role: "support", tier: "A", accent: "#22c55e",
    skillName: "Work",
    abilityKm: "សម្គាល់សត្រូវដែលមានតម្លៃរង្វាន់។ ក្រុមដែលសម្លាប់សត្រូវដែលសម្គាល់ទទួលបាន 200 ហើយអ្នកទទួលបាន 100 បន្ថែម",
    abilityEn: "Marks enemies with bounty value. Team killing a marked enemy gets 200, you get 100 extra",
    cooldown: "Passive", bestWeapon: "MP40 / M1887",
    tipsKm: "សម្គាល់សត្រូវឱ្យបានច្រើន ដើម្បីទទួលបានកាក់ FF", tipsEn: "Mark enemies to earn FF coins",
    bestForKm: "ការគាំទ្រផ្នែកហិរញ្ញវត្ថុ", bestForEn: "Financial support" },

  { id: "koda", name: "Koda", emoji: "🦊", role: "recon", tier: "A", accent: "#f59e0b",
    skillName: "Aurora Vision",
    abilityKm: "បង្កើនល្បឿនចលនា 15% និងបង្ហាញសត្រូវដែលលាក់ខ្លួនក្នុងរង្វង់ 50m រៀងរាល់ 1 វិនាទី រយៈពេល 8 វិនាទី",
    abilityEn: "Increases movement speed by 15% and reveals enemies behind cover within 50m every 1s for 8s",
    cooldown: "45s", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើដើម្បីរកសត្រូវលាក់ខ្លួន និងរត់លឿន", tipsEn: "Use to find hiding enemies and run fast",
    bestForKm: "ការរកសត្រូវ", bestForEn: "Enemy detection" },
{ id: "orion", name: "Orion", emoji: "👹", role: "tank", tier: "A", accent: "#3b82f6",
    skillName: "Crimson Crush",
    abilityKm: "ប្រើ 200 Crimson Energy ដើម្បីស្រូបយកការខូចខាត និងស្រូបយក 10 HP ពីសត្រូវក្នុងរង្វង់ 5m",
    abilityEn: "Consumes 200 Crimson Energy to absorb damage and steal 10 HP from enemies within 5m",
    cooldown: "50s", bestWeapon: "M1014 / Groza",
    tipsKm: "ប្រើពេលកំពុងត្រូវវាយ ដើម្បីស្រូបយកការខូចខាត", tipsEn: "Use when taking damage to absorb it",
    bestForKm: "ការការពារ", bestForEn: "Defense" },

  { id: "oscar", name: "Oscar", emoji: "🎭", role: "rusher", tier: "A", accent: "#ef4444",
    skillName: "Valiant Dash",
    abilityKm: "ដាច់ទៅមុខ បំផ្លាញ Gloo Wall និងបង្កការខូចខាត 25% បន្ថែមដល់សត្រូវក្នុងរង្វង់",
    abilityEn: "Dashes forward, destroying Gloo Walls and dealing 25% extra damage to enemies in range",
    cooldown: "45s", bestWeapon: "M1887 / MP40",
    tipsKm: "ប្រើដើម្បីបំផ្លាញ Gloo Wall សត្រូវ និងវាយប្រហារភ្លាមៗ", tipsEn: "Use to destroy enemy Gloo Walls and attack instantly",
    bestForKm: "ការវាយប្រហារលឿន", bestForEn: "Fast attacks" },

  { id: "rin_yagami", name: "Rin Yagami", emoji: "🗡️", role: "rusher", tier: "A", accent: "#ef4444",
    skillName: "Gale of Kunai",
    abilityKm: "ស្វ័យប្រវត្តិបោះគុណៃរហូតដល់ 3 ទៅសត្រូវ ឬ Gloo Wall នៅពេលកំពុងសំដៅ",
    abilityEn: "Automatically throws up to 3 kunai at enemies or Gloo Walls when aiming",
    cooldown: "Passive", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើដើម្បីបំផ្លាញ Gloo Wall សត្រូវយ៉ាងលឿន", tipsEn: "Use to destroy enemy Gloo Walls quickly",
    bestForKm: "ការប្រឆាំង Gloo Wall", bestForEn: "Countering Gloo Walls" },

  { id: "clu", name: "Clu", emoji: "📡", role: "recon", tier: "A", accent: "#f59e0b",
    skillName: "Tracing Steps",
    abilityKm: "កំណត់ទីតាំងសត្រូវក្នុងរង្វង់ 75m ដែលកំពុងផ្លាស់ទីជាក្រុម",
    abilityEn: "Locates enemies within 75m radius who are moving in groups",
    cooldown: "50s", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើដើម្បីស្កេនក្រុមសត្រូវជិតៗ", tipsEn: "Use to scan nearby enemy squads",
    bestForKm: "ការស្កេនក្រុម", bestForEn: "Squad tracking" },

  { id: "clu_recon", name: "Clu (Alt)", emoji: "🔍", role: "recon", tier: "B", accent: "#f59e0b",
    skillName: "Scan",
    abilityKm: "ស្កេនសត្រូវជុំវិញរយៈពេល 3 វិនាទី",
    abilityEn: "Scans enemies in radius for 3 seconds",
    cooldown: "50s", bestWeapon: "MP40 / M1887",
    tipsKm: "ប្រើដើម្បីស្កេនសត្រូវមុនវាយ", tipsEn: "Use to scan enemies before attacking",
    bestForKm: "ការស្កេន", bestForEn: "Scanning" },
];
