...
export const TOOLS: Tool[] = [
  {
    ...
    descKm: "ពិនិត្យថាតើទូរស័ព្ទរបស់អ្នកលេង FF និង MLBB បាន FPS ប៉ុន្មាន — ៥០+ ម៉ូដែល",
    descEn: "Check your phone's FPS for FF and MLBB — 50+ models",
  ...
  },
  {
    ...
    descKm: "ហាត់ headshot ឱ្យបានជាប់ជាប្រចាំ",
  ...
  },
  {
    ...
    descKm: "វិធីទទួលបាន diamond ដោយឥតគិតថ្លៃ (ស្របច្បាប់)",
